...
void seq_echange(sotl_atom_set_t * set, int a, int b){
	calc_t tmpx;
	calc_t tmpy;	
	calc_t tmpz;
	calc_t tmpsx;
...
void seq_tri(sotl_atom_set_t * set){
...
static void seq_force_Z (sotl_device_t *dev)
{
  sotl_atom_set_t *set = &dev->atom_set;
  seq_tri(set);
...
void seq_force_cube(sotl_device_t *dev){
